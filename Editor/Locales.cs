        ...
        private static void Initialize()
        {
            Gettext.SetLocalizedTexts(localizedTexts: new Dictionary<string, IDictionary<string, string>> {
                { "ja", new Dictionary<string, string> {
                    ...
                    { "There is no VRMBlensShapePreset “{0}”.", "VRMBlensShapePreset「{0}」が存在しません。" },
                    ...
                    { "The “PhysBones Components” is {0}.",
                        "「PhysBones Components」(VRCPhysBoneコンポーネントの数) が{0}です。" },
                    { "The “PhysBones Simulated Bone Count” (Number of bones including root in VRCPhysBone) is {0}.",
                        "「PhysBones Simulated Bone Count」(VRCPhysBoneのルートを含むボーンの数) が{0}です。" },
                    { "The “PhysBones Colliders” is {0}.",
                        "「PhysBones Colliders」(VRCPhysBoneColliderコンポーネントの数) が{0}です。" },
                    { "The “PhysBones Collision Check Count” (Number of bones excluding root in VRCPhysBone × Number of VRCPhysBoneCollider) is {0}.",
                        "「PhysBones Collision Check Count」(VRCPhysBoneのルートを含まないボーンの数×VRCPhysBoneColliderの数) が{0}です。" },
                    { "If this value exceeds {0}, you cannot upload your avatar.",
                        "この値が{0}を超えていると、アバターをアップロードできません。" },
                    { "If this value exceeds {0}, all VRCPhysBones will be disabled under the default user setting.",
                        "この値が{0}を超えていると、デフォルトのユーザー設定ではすべてのVRCPhysBoneが無効化されます。" },
